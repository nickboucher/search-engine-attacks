...
class adversarial_summarizer():
    ...
    def sanitize(self, x):
        ...
        x = list(x)
        x = [xx for xx in x if xx != self.zws]
        x = ''.join(x)
        return x
...
if __name__ == '__main__':
    ...
    for idx, article in enumerate(ARTICLES):
        ...
        filename = f"./results/zwnj/{idx}.json"
